...
V6 as written); **D2** — the user is the sole annotator (R12.6, R8.4; for Stage 1 gold only, amended 2026-09-23 by `specs/release-parser-fidelity.md` F9: Codex or Gemini may draft, the user verifies every block);
